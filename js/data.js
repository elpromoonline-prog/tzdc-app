// ─── DADOS DO APP TZDC v4 ──────────────────────────────────────────────────
// ATENÇÃO: Nenhuma menção a empresas, grupos ou marcas específicas.
// A narrativa do criador usa sempre: "uma carreira no alto escalão
// do relacionamento corporativo brasileiro"
...
// ── LIMITES POR PLANO ──────────────────────────────────────────────────────
// Origem:   1 geração de relatório (pagamento único)
// Método:   30 sessões de coach/mês
// Maestria: 60 sessões de coach/mês
const LIMITES_PLANO = { 'Origem': 1, 'Método': 30, 'Maestria': 60 };

// ── API CONFIG ─────────────────────────────────────────────────────────────
// Em produção: use "/api/chat" (Vercel Function) — nunca a chave direto no frontend
const API_CONFIG = { endpoint: "/api/chat", model: "claude-sonnet-4-20250514", max_tokens: 1000 };
